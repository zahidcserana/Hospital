     ...
     components: {
        ...
        created() {
            if (this.editMode) {
                ...
                this.form.contact_person_name = this.data.contact_person_name
                this.form.contact_person_mobile = this.data.contact_person_mobile
        ...
        methods: {
            ...
            save: function (data) {
                this.$inertia.post('/suppliers', data)
            },
            edit: function (data) {
            ...
            update: function (data) {
                data._method = 'PUT';
                this.$inertia.post('/suppliers/' + data.id, data)
            }
        }
    }
</script>
