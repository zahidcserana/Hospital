                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                             <jet-responsive-nav-link :href="route('product-categories.edit', [row.id])" :active="route().current('product-categories.create')" class="dropdown-item">
     ...
     components: {
        ...
        methods: {
            deleteRow: function (data) {
                ...
                data._method = 'DELETE';
                this.$inertia.post('/product-categories/' + data.id, data)
            }
        }
    }
</script>
